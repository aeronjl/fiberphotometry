...
| Behavioral/event-kernel GLMs | **Experimental** | FIR kernels, explicit validity masks, grouped validation, conditional jackknife intervals, gap-safe diagnostics and named whole-model multiverses; add basis/history/duration/contribution families and formal interval coverage |
