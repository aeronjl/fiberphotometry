...
| Behavioral/event-kernel GLMs | **Experimental** | Full-FIR and raised-cosine kernels, explicit validity masks, grouped validation, conditional jackknife intervals, gap-safe diagnostics and named whole-model multiverses; add history/duration/contribution families and formal interval coverage |
