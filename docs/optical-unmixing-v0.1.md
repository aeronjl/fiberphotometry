...
a [robustness multiverse](multiverse-contract-v0.1.md) when both are scientifically
defensible. Run [sensor/isobestic validity](optical-validity-v0.1.md) and inspect
...
See
[SDR-0052](decisions/0052-require-independent-identification-for-optical-unmixing.md)
