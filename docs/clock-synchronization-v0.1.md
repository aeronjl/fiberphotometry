...
## Interpolation is not synchronization
...
1. identify pulse correspondences without accessing neural outcomes;
...
mapping should automatically be fitted after seeing neural outcomes.

See [SDR-0004](decisions/0004-require-explicit-derived-data-alignment.md) for the
original alignment requirement and
[SDR-0034](decisions/0034-fit-only-explicit-matched-pulse-clock-transforms.md) for
this synchronization policy.
