...
[`benchmarks/ibl-feedback-analysis-v0.1.json`](../benchmarks/ibl-feedback-analysis-v0.1.json).
The frozen specification is
[`benchmarks/protocol-ibl-feedback-v0.1.md`](../benchmarks/protocol-ibl-feedback-v0.1.md).
