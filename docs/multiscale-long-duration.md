...
- Use [spontaneous-transient analysis](spontaneous-transients.md) when the
  estimand is event rate, amplitude, width, or area.
- Use [time, frequency, and state analysis](spectral-state-analysis.md) for
...
multiple sensors and acquisition systems.
