...
Install published-package support with `pip install "fiberphotometry[stats]"`.
...
The frozen [v0.2 parity fixture](../benchmarks/mixed-model-parity-v0.2.json)
...
The method's role is governed by
[SDR-0010](decisions/0010-mixed-models-are-sensitivity-summaries.md).
