...
`SensorKinetics` in a
[versioned sensor profile](optical-validity.md#declare-a-versioned-sensor-profile)
...
Run [sensor and reference validity](optical-validity.md) and any relevant
[optical unmixing](optical-unmixing.md) before this stage.
