...
Generate `usability-study-report.html` with the committed example and record its
Git commit and SHA-256. The report contains deterministic illustrative outcomes so
