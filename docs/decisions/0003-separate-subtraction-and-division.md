...
- Related protocol/report:
  [protocol v0.2](https://github.com/aeronjl/fipha/blob/main/benchmarks/protocol-control-free-v0.2.md),
  [report v0.2](https://github.com/aeronjl/fipha/blob/main/research/control-free-benchmark-v0.2.md)
