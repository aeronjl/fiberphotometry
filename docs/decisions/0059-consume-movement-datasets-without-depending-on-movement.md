...
- **Status:** Accepted
- **Date:** 2026-07-28
- **Related decisions:** [SDR-0032](0032-preserve-external-behavior-semantics.md), [SDR-0033](0033-retain-validity-masks-without-compressing-time.md), [SDR-0050](0050-preserve-ndx-pose-values-and-declare-link-omissions.md)
...
`interoperability.py`, which accepts a `movement` poses `Dataset` and returns a
