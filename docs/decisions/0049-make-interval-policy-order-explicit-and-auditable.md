...
- **Status:** Accepted
- **Date:** 2026-07-28
- **Related decisions:** [SDR-0032](0032-preserve-external-behavior-semantics.md), [SDR-0038](0038-model-variable-duration-behavior-with-physical-intervals-and-progress.md)
...
- The package never reorders operations or selects thresholds from photometry.
