...
Pose, behavioral annotations and photometry frequently originate from different
...
the photometry grid remains a later, separate operation.

## Consequences

The package now offers a valid path from distinct behavior and photometry clocks
