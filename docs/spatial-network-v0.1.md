...
Run [crosstalk and shared-control review](multisite-multicolor-analysis-v0.1.md)
and, when applicable, [wavelength-aware optical unmixing](optical-unmixing-v0.1.md)
...
[SDR-0053](decisions/0053-treat-spatial-edges-as-within-mouse-evidence.md).
