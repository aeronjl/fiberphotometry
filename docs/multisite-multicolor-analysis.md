...
[dense-array spatial workflow](spatial-network.md); neither API treats sites
...
[gap-aware spectral contract](spectral-state-analysis.md). No function
...
[population inference across core workflows](population-workflow-adapters.md).

For complete lag-association or coherence curves, use the
[population-curve workflow](population-curve-inference.md). It retains valid
