...
```python
from fipha.multiverse import MultiverseReportGroup
...
[interface system](https://github.com/aeronjl/fipha/blob/main/.interface-design/system.md).

The deterministic synthetic report used to evaluate whether scientists understand
this contract is generated by
[`examples/grouped_multiverse_report.py`](https://github.com/aeronjl/fipha/blob/main/examples/grouped_multiverse_report.py).
The frozen [formative usability study](https://github.com/aeronjl/fipha/blob/main/planning/usability/README.md) separates participant
...
the normative
[`multiverse-lane-summary-v1` schema](https://github.com/aeronjl/fipha/blob/main/schemas/multiverse-lane-summary-v1.schema.json).
