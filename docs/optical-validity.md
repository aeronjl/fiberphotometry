...
[wavelength-aware optical unmixing](optical-unmixing.md). A numerically
...
[sensor-kinetic modeling workflow](sensor-kinetic-modeling.md) now supports
...
See the [capability matrix](methods/capability-matrix.md) for adjacent roadmap
gaps.
