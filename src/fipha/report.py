...
from fipha.design import Scalar
from fipha.qc import RecordingQC, SignalChannelQC, SignalRecordingQC
...
<main>
  ...
  <footer>Generated by fipha · input fingerprint
...
{incompatible_section}
  <footer>Generated by fipha · grouped summaries are unit-local by
  contract.</footer>
</main></body></html>"""
...
def _validate_multiverse_groups(
    ...
    from fipha.multiverse import _validated_group_universes
...
def _operation_cards(recordings: tuple[xr.Dataset, ...]) -> str:
    ...
    for recording in recordings:
        raw = recording.attrs.get("fipha_operations", "[]")
