...
from fipha.io.nwb import NWBAcquisitionMetadata, add_recording_to_nwb
from fipha.metadata import assess_metadata_completeness
from fipha.multiverse import MultiverseReportGroup, MultiverseResult
from fipha.pipeline import RecordingInput, run_pipeline
from fipha.project import LoadedTabularProject, ProjectConfig
from fipha.workflow import EventAnalysisResult
    ...
    for source, session, item, inspection, processed, quality in zip(
        ...
        nwbfile = NWBFile(
            ...
            experiment_description=(
                "Fiber photometry project exported by fipha; see scratch "
