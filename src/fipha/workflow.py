...
from fipha.planning import AnalysisPlan, create_analysis_plan
...
class EventAnalysisResult:
            ...
            "processing_lineage": [
                {
                    ...
                    "operations": json.loads(
                        str(recording.attrs.get("fipha_operations", "[]"))
                    ),
                }
    ...
    def to_html(self) -> str:
        ...
        from fipha.report import render_event_analysis_report
